...
public class RoomDataRepository {
    ...
    public int add(RoomData roomData) {
        String sql = "INSERT INTO room (room_id, leader_id, top3_count) VALUES (?, ?, ?)";
        return jdbcTemplate.update(sql, roomData.getRoomID(), roomData.getLedder_id(), roomData.getTop3Count());
    }
